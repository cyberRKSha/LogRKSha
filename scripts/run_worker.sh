#!/bin/bash
# This script runs the worker.py with the correct Python interpreter
...
WORKER_SCRIPT="$PROJECT_DIR/scripts/worker.py"
...
echo "Starting worker with root privileges to read system logs..."
echo "Your password may be required."
echo "Press Ctrl+C to stop the monitor."

sudo "$VENV_PYTHON" "$WORKER_SCRIPT"
